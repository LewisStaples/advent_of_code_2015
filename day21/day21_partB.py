...
# You must use exactly one weapon
# You can use either 0 or 1 pieces of armor
# You can use 0, 1, or 2 rings
...
for purchase_quantities_per_category in purchase_amount_options_iter:
    ...
    for single_purchase_option in list_of_purchase_options:
        ...
        if the_game.run_game(False) == 'The boss':
            dummy = 123
            ...
            if player_variables in brute_forced_options:
                brute_forced_options[player_variables] = max(brute_forced_options[player_variables] , single_purchase_option__totaled_cost_dmg_armr[0])
            else:
